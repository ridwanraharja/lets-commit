...
export default function StatsSection() {
  ...
  const { useGetStatistics } = useEventService();

  const { data: statistics } = useGetStatistics();

  const formatStatistics = useMemo(() => {
    if (!statistics) return statsConst;
    ...
    return [
      {
        title: "Total Events",
        value: formatNumber(statistics.totalEventCreated),
        description: "Successfully created learning events",
        icon: Calendar,
        trend: "+12%",
      ...
      },
      {
        ...
        value: formatNumber(statistics.totalParticipantEnrolled),
      ...
      {
        title: "Total Balance Managed",
        value: formatCurrency(statistics.totalBalanceManaged),
        description: "Total balance managed by our platform",
        icon: Coins,
        trend: "+18%",
      ...
      >
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            >
              Join thousands of learners who have experienced the benefits of
              our commitment-based learning system
            </motion.p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            {formatStatistics.map((stat, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`inline-flex items-center gap-1 text-xs md:text-sm font-semibold px-2 py-1 rounded-full ${
                        stat.variant === "success"
            ...
            <div className="relative z-10 space-y-4 md:space-y-5">
              ...
              >
                ...
                <span className="text-white font-semibold">
                  Get your money back by completing what you{" "}
                </span>
              ...
              >
                Put your money where your commitment is. Complete your learning
                journey and get a{" "}
