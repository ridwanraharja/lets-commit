...
export  const ourStory = [
    {
      ...
      title: "The Spark",
      icon: "💡",
      description: "It all started with a simple frustration - why do so many online courses go unfinished?",
      details: "We noticed that people were excited to learn but struggled with commitment and accountability.",
      emotion: "Curiosity"
    },
    {
      step: 2,
      title: "The Eureka",
      icon: "⚡",
      description: "What if we could align financial incentives with learning goals?",
      details: "The idea of commitment-based learning was born - put your money where your motivation is.",
      emotion: "Excitement"
    },
    {
      step: 3,
      title: "The Team",
      icon: "🤝",
      description: "Four developers with different superpowers came together with a shared vision.",
      details: "Each bringing unique skills but united by the goal of revolutionizing education.",
      emotion: "Unity"
    },
    {
      step: 4,
      title: "The Build",
      icon: "🚀",
      description: "Months of coding, designing, and iterating to create something truly special.",
      details: "From smart contracts to beautiful UIs, every line of code written with purpose.",
...
export  const companyVibes = [
    {
      ...
      description: "Our code quality is directly proportional to our caffeine intake",
    ...
    },
    {
      ...
      description: "We don't just follow trends, we create them with cutting-edge solutions",
    ...
    },
    {
      icon: Heart,
      title: "People First",
      description: "Every feature we build starts with 'How can this help our users?'",
      color: "text-pink-500",
    ...
    },
    {
      ...
      description: "We believe in rapid iteration and getting things into users' hands quickly",
      color: "text-blue-500",
