    ...
    <>
      ...
      >
        <div className="container mx-auto px-3 sm:px-4 md:px-6 py-3.5 md:py-6">
          <div className="flex justify-between items-center">
            ...
            >
              <div className="relative">
                <div className={`w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg md:shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-200 ease-in-out ${
                  isHome ? "ring-2 ring-blue-300 dark:ring-blue-600 ring-offset-2 dark:ring-offset-gray-900" : ""
                }`}>
                  <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white group-hover:rotate-12 transition-transform duration-200 ease-in-out" />
                </div>
              ...
              {isConnected ? (
                <div className="relative dropdown-container">
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 ease-in-out group text-base"
                  >
                    ...
                    <ChevronDown className={`w-4 h-4 transition-transform duration-200 ease-in-out ${isProfileOpen ? 'rotate-180' : ''}`} />
                  </button>

                  {/* Profile Dropdown */}
                  {isProfileOpen && (
                    <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 py-2 z-[60] transition-all duration-200 ease-in-out">
                      ...
                      <div className="py-2">
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 ease-in-out text-base"
                        >
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 ease-in-out text-base"
                        >
                ...
                <button
                  ...
                  className="group relative px-4 py-3 lg:px-6 lg:py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 text-white rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200 ease-in-out overflow-hidden text-base font-semibold"
                >
                  <span className="relative z-10 flex items-center gap-2">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-200 ease-in-out"></div>
                </button>
              )}
            </div>
              ...
              {isConnected ? (
                <div className="relative mobile-wallet-container">
                  <button
                    ...
                    className="p-2 sm:p-2.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg transition-all duration-200 ease-in-out touch-manipulation"
                    type="button"
                  >
                  ...
                  {isMobileWalletOpen && (
                    <div className="absolute right-0 top-full mt-2 w-56 sm:w-64 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 py-2 z-[65] transition-all duration-200 ease-in-out">
                      ...
                      <div className="py-2">
                        <button
                          ...
                          className="w-full flex items-center gap-2 sm:gap-3 px-3 py-2 sm:px-4 sm:py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 ease-in-out text-sm"
                        >
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-2 sm:gap-3 px-3 py-2 sm:px-4 sm:py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 ease-in-out text-sm"
                        >
          ...
          <div
            className={`mobile-dropdown lg:hidden overflow-hidden transition-all duration-200 ease-in-out ${
                ...
                {!isConnected && (
                  <div className="pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-gray-200 dark:border-gray-700">
                    <button
                      ...
                      className="w-full px-4 py-3 sm:px-6 sm:py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 text-white font-medium sm:font-bold rounded-xl sm:rounded-2xl shadow-lg transition-all duration-200 ease-in-out flex items-center justify-center gap-2 touch-manipulation text-sm sm:text-base"
                      type="button"
                    >
                      <RiWallet3Line className="w-4 h-4 sm:w-5 sm:h-5" />
                      Connect Wallet
        ...
        <div className="flex justify-around items-center py-2 sm:py-3 px-1 sm:px-2">
          {mobileNavLinks.map((link) => (
            ...
            >
              {({ isActive }) => (
                <>
                  <div className={`relative w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl transition-all duration-200 ease-in-out flex items-center justify-center ${
                    isActive 
                  ...
                  <span className={`text-xs pt-1 font-medium transition-all duration-200 ease-in-out text-center leading-tight ${
                    isActive ? "font-bold" : ""
